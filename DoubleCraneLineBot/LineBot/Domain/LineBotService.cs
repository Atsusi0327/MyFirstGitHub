...
using System.Text;
using DoubleCraneLineBot.LineBot.Dtos.Actions;

namespace DoubleCraneLineBot.LineBot.Domain
{
    public class LineBotService
    {

        // 貼上 messaging api channel 中的 accessToken & secret
        private readonly string channelAccessToken = "AjOwZmp+n4A5Or4TH4qc19UPF4lqyVKsoNskhd0j/mLyvj9FAYqQPrDuLJ0bNn1QY3bdvXlhyFC2KM9Z4QoBvHVnQ/afF8Wj95suK3Cb8NjPfTkzI3DmF3mx+oLSyvPavirswng26JQ89yhmOKhQWQdB04t89/1O/w1cDnyilFU=";
        private readonly string channelSecret = "9860d59f2b78b69bb589d1f3a0655b5e";
                ...
                case MessageTypeEnum.Text:
                        ...
                        replyMessage = new ReplyMessageRequestDto<TextMessageDto>
                        {
                            ...
                            Messages = new List<TextMessageDto>
                            {
                                new TextMessageDto
                                {
                                    ...
                                    {
                                        Name = "客服人員 1號",
                                        IconUrl = "https://537e-123-51-166-192.jp.ngrok.io/UploadFiles/man.png"
                                    }
                                },
                                new TextMessageDto
                                {
                                    ...
                                    {
                                        Name = "客服人員 2號",
                                        IconUrl = "https://537e-123-51-166-192.jp.ngrok.io/UploadFiles/gamer.png"
                                    }
                                }
                            }
                        };
                    ...
                    else
                    {
                        replyMessage = new ReplyMessageRequestDto<TextMessageDto>()
                        {
                            ...
                            Messages = new List<TextMessageDto>
                            {
                                new TextMessageDto(){Text = $"您好，您傳送了\"{eventDto.Message.Text}\"!"}
                            }
                        };
                    }
                    break;
